...
export default class UserTours extends Component {
  ...
  deleteTour = (tourid) => {
    axios
      .delete(`http://localhost:3000/users/deletetour/` + tourid)
      .then((response) => {
    ...
    return (
      ...
      >
        ...
        {this.state.dataFound ? (
          <>
            <TableContainer style={{ marginTop: '11%' }} component={Paper}>
                ...
                <TableBody>
                  {this.state.tours.map((tour, index) => (
                    <StyledTableRow key={tour.source}>
                      ...
                      <StyledTableCell align="center">
                        {tour.inputDetails.source}
                      </StyledTableCell>
                      <StyledTableCell align="center">
                        {tour.inputDetails.destination}
                      </StyledTableCell>
                      <StyledTableCell align="center">
                        {tour.inputDetails.startdate}
                      </StyledTableCell>
                      <StyledTableCell align="center">
                        {tour.inputDetails.enddate}
                      </StyledTableCell>
                      <StyledTableCell align="center">
                        {tour.created_at.slice(0, 10)}
                      </StyledTableCell>
                      <StyledTableCell align="center">
                        {tour.budget == undefined
                          ? 2000
                      ...
                      <StyledTableCell align="center">
                        <IconButton aria-label="view">
                          <PageviewIcon
                            id="viewIcon"
                            onClick={() => this.showModal(tour, index)}
                          />
                        </IconButton>
                      </StyledTableCell>
                      <StyledTableCell align="center">
                        <IconButton aria-label="view">
                          <PrintIcon
                            id="printIcon"
                            onClick={() => this.showprintModal(tour, index)}
                          />
                        </IconButton>
                      </StyledTableCell>
                      <StyledTableCell align="center">
                        <IconButton aria-label="delete">
                          <DeleteIcon
                            id="delIcon"
                            fontSize="medium"
                            onClick={this.deleteTour.bind(this, tour._id)}
                          />
                        </IconButton>
                      </StyledTableCell>
                    </StyledTableRow>
          ...
          <div id="notfound">
            <Notfound
              ...
              sidemessage="Want to make exciting trips?"
              detail={[
                'Go to ',
                <strong>Plan Trips </strong>,
                'and create your desired trips.',
              ]}
            />{' '}
          </div>
        )}
      ...
      <div>
        ...
        <List style={{ width: '320px', marginLeft: '5.5%', marginTop: '-1%' }}>
          ...
          <ListItem>
            ...
            <ListItemText
              primary="Tour Days"
              secondary={this.state.totalDays + ' Days'}
            />
          </ListItem>
          {this.state.totalDays >= this.state.tripDays ? (
            ...
            <ListItem>
              ...
              <ListItemText
                primary="Extra Days"
                secondary={
                  this.state.tripDays - this.state.totalDays + ' Days '
                }
              />
            </ListItem>
          )}
          <ListItem>
            ...
            <ListItemText
              ...
              secondary={
                ...
                ` PKR (${this.state.totalDays} Days for ${this.state.inputDetails.Adults} people)`
              }
            />
          </ListItem>
          <ListItem>
          ...
          {this.state.transportType == 'Rental' ? (
            <ListItem>
              ...
              <ListItemText
                ...
                secondary={
                  this.state.vehiclePrice.toLocaleString() +
                  ` PKR (${this.state.totalDays} Days)`
                }
              />
            </ListItem>
          ) : (
          ...
          {this.state.transportType == 'Bus' ? (
            <ListItem>
              ...
              <ListItemText
                ...
                secondary={
                  this.state.vehiclePrice.toLocaleString() +
                  ` PKR (${this.state.totalDays - 1} Days Including Bus)`
                }
              />
            </ListItem>
          ) : (
        ...
        <Timeline style={{ marginLeft: '-80%' }}>
          <h4
            style={{ textAlign: 'left', marginLeft: '46%', fontSize: '22px' }}
          >
            <PlaceIcon style={{ marginTop: '-0.5%', fontSize: '19px' }} />
            {this.state.inputDetails.destination}
          </h4>
          ...
          <TimelineItem>
            ...
            <TimelineContent>
              <Typography>{this.state.selectedHotel[0]?.name}</Typography>
              <Typography variant="body2" color="textSecondary">
                &nbsp;&nbsp;{this.state.startTime} am
              </Typography>
            </TimelineContent>
          ...
          {this.state.selectedPoi.map((poi, index) => (
            <div>
              {index == 0 ? (
                <></>
              ) : index % 3 == 0 ? (
                      ...
                      <div className="col-md-8">
                        <div className="card-body">
                          <h4
                            ...
                            style={{ color: '#001529', wordBreak: 'break-all' }}
                          >
                            {poi.name}
                          </h4>
              ...
              <TimelineItem>
                ...
                <TimelineContent>
                  <Typography>Driving</Typography>
                  <Typography variant="body2" color="textSecondary">
                    {index == 2 || index == this.state.selectedPoi.length - 1
              ...
              ) : index == this.state.selectedPoi.length - 1 ||
                (index + 1) % 3 == 0 ? (
        ...
        <List style={{ width: '320px', marginLeft: '1%', marginTop: '-1%' }}>
          ...
          <ListItem>
            ...
            <ListItemText
              ...
              secondary={
                this.state.hotelPrice.toLocaleString() +
                ` PKR (${this.state.inputDetails.Adults} people)`
              }
            />
          </ListItem>
          <ListItem>
          ...
          {this.state.transportType == 'Bus' ? (
            <ListItem>
              ...
              <ListItemText
                ...
                secondary={
                  this.state.vehiclePrice.toLocaleString() +
                  ` PKR (${this.state.tripDays - 1} Days Including Bus)`
                }
              />
            </ListItem>
          ) : (
