                    ...
                    <Table aria-label="customized table" style={{ width: '95%' }}>
                        <TableHead>
                            <TableRow>
                                ...
                                <StyledTableCell align="center">Places to visit #</StyledTableCell>
                        ...
                        <TableBody>
                            {this.state.tours.map((tour, index) => (
                                <StyledTableRow key={tour.source}>
                                    ...
                                    <StyledTableCell align="center">{tour.selectedPoi.length} POI's</StyledTableCell>
                                    <StyledTableCell align="center">{tour.tourDay} Days</StyledTableCell>
