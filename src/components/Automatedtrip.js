          ...
          <div className="container">
            <div className="row">
              <div
                ...
                style={{ marginLeft: '33%', overflowY: 'hidden' }}
              >
                <div
                  className="booking-form"
                  style={{ height: '520px', marginTop: '25%' }}
                >
                    ...
                    <div className="form-group">
                      ...
                      <span
                        ...
                        onClick={() => {
                          ...
                          document.getElementById('manual_origin').value = null;
                          this.setState({ origin: null });
                        }}
                      >
                        <EditIcon id="transiconsedit" />
                      </span>
                    </div>
                    <div className="form-group">
...
export default function Manualtrip() {
  ...
  const submitForm = () => {
    if (activeStep == 0) {
      ...
      if (
        activeStep == 0 &&
        (source && destination && startdate && enddate && budget && Adults) ===
          ''
      ) {
        setSnackbar(true);
      }
      ...
      activeStep == 1 &&
      localStorage.getItem('transportType') != 'Bus'
    ) {
  ...
  return (
    ...
    >
      ...
      <Snackbar
        ...
        onClose={handleClose}
        style={{ position: 'absolute', left: '81%', top: '40%' }}
      >
      ...
      <Snackbar
        open={snackbar}
        style={{ position: 'absolute', left: '81%', top: '20%' }}
        autoHideDuration={800}
        onClose={handleClose}
      >
        <Alert onClose={handleClose} severity="error">
...
class Manualcheckroute extends Component {
  ...
  async componentWillMount() {
    ...
    axios
      .get(
        `https://maps.googleapis.com/maps/api/place/textsearch/json?query=${destination}+point+of+interest&language=en&key=AIzaSyD0FFwKL9zAZIpjkM9zf7CKQeNoFUIE6Ss`,
        {
          headers: {
      ...
      .then((response) =>
        response.data.results.map((poi) => ({
          ...
          latLng: [
            { lat: poi.geometry.location.lat, lng: poi.geometry.location.lng },
          ],
          rating: poi.rating,
      ...
      .then((POIS) => {
        ...
        fetchedPOI = this.state.selectedPoi.sort(
    ...
    axios
      ...
      .then((Hotels) => {
        ...
        var result = this.state.HotelsData.sort(
  ...
  vehicleSelection = () => {
    ...
    let vehicles = [
      { name: 'Toyota Vitz', price: 3200 },
      { name: 'Toyota GLI (Automatic)', price: 4200 },
    ];
    let buses = [
      { name: 'Toyota Hiace', price: 6500 },
      { name: 'Toyota Coaster (Ceylon)', price: 11000 },
    ];
    ...
    return (
      <div>
        ...
        >
          ...
          >
            Route Details{' '}
            <PlaceIcon style={{ verticalAlign: '-5px', color: 'white' }} />
          </h4>
          {this.state.travelTime != null ? (
            <div>
              <h4
                style={{
                  paddingLeft: '5%',
              ...
              >
                <strong>Distance is:</strong> {this.state.travelDistance} Km's
              </h4>
              {this.state.transportType === 'Bus' ? (
                ...
                >
                  <strong>Fuel:</strong> {this.state.fuelUsed}&nbsp;Ltr's approx
                </h4>
              )}
              <h4
                style={{
              ...
              >
                <strong>Time required:</strong> {this.state.travelTime}
                &nbsp;Hr's
                <br />
              </h4>{' '}
            </div>
        ...
        {this.state.dataFetched ? (
          <div id="mapCanvas" style={{ position: 'relative', height: '400px' }}>
            ...
            <GoogleMapExample
              ...
              mapElement={
                <div
                  id="mapitself"
                  style={{ height: `55%`, width: '35%', marginLeft: '8%' }}
                />
              }
            />
            <Button
          ...
          <Spin style={{ marginLeft: '41%', marginTop: '15%' }} size="large" />
        )}
        {this.state.transportType !== 'Bus' && travelTime >= '10:00:00' ? (
          <>
            <Snackbar
            ...
            >
              ...
              <TextField
                onChange={this.stayCityName}
                style={{ marginLeft: '13%' }}
                id="standard-secondary"
                label="Where would you stay?*"
                color="secondary"
              />
            </div>
          </>
