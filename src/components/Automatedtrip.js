                                        ...
                                        <div className="row">
                                            <div className="col-sm-6">
                                                <div className="form-group">
                                                    ...
                                                    <input className="form-control" type="date" id="startdate" min="2020-12-11" max="2020-12-20" style={{ fontSize: '12px' }} onChange={this.startdateChange} value={this.state.startdate} required />
                                                </div>
                                            </div>
                                            <div className="col-sm-6">
                                                <div className="form-group">
                                                    <span className="form-label">End date</span>
                                                    <input className="form-control" id="enddate" style={{ fontSize: '12px' }}  min="2020-12-11" max="2020-12-20" onChange={this.enddateChange} type="date" value={this.state.enddate} required />
                                                </div>
                                            </div>
                                        </div>
                                        <div className="form-group">
...
export default function AutomatedTrip() {
    ...
    Inputdetails = { source: source, destination: destination, startdate: startdate, enddate: enddate, travelFuel: travelFuel, travelDistance: travelDis, travelTime: travelTime, stayCity: stayCity, transportType: transportType }
    return (
